...
import static cn.xiuminglee.jt809.common.Const.BusinessDataType.UP_CONNECT_REQ;
import static cn.xiuminglee.jt809.common.Const.BusinessDataType.UP_EXG_MSG;
import static cn.xiuminglee.jt809.common.util.CommonUtils.PACKET_CACHE;
import static cn.xiuminglee.jt809.common.util.CommonUtils.bytes2bitStr;
...
public class JT809DecoderAdapter extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        log.info("bytes:{}", bytes2bitStr(bytes));
        // 2、校验crc
